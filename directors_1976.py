...
import sys
sys.stdout = open('directors_1976_link_prediction.txt', 'w')
...
# Configuration
NETWORK_PATH = "directors_meetings/directors_1976"
RESULTS_DIR = "directors_1976_predictions"
RANDOM_STATE = 42
...
def save_experiment_results(all_results, network_info):
    ...
    # Save to Excel file
    excel_file = os.path.join(RESULTS_DIR, "directors_1976_results.xlsx")
...
def create_visualizations(summary_df, network_info):
    ...
    for sampling_method in sampling_methods:
        ...
        fig1.tight_layout()
        plot_file1 = os.path.join(RESULTS_DIR, f"directors_1976_aupr_if_predictions_{sampling_suffix}.png")
        ...
        fig2.tight_layout()
        plot_file2 = os.path.join(RESULTS_DIR, f"directors_1976_auc_predictions_{sampling_suffix}.png")
        ...
        fig3.tight_layout()
        plot_file3 = os.path.join(RESULTS_DIR, f"directors_1976_aupr_predictions_{sampling_suffix}.png")
        ...
        fig4.tight_layout()
        plot_file4 = os.path.join(RESULTS_DIR, f"directors_1976_aupr_if_table_{sampling_suffix}.png")
        ...
        fig5.tight_layout()
        plot_file5 = os.path.join(RESULTS_DIR, f"directors_1976_auc_table_{sampling_suffix}.png")
        ...
        fig6.tight_layout()
        plot_file6 = os.path.join(RESULTS_DIR, f"directors_1976_aupr_table_{sampling_suffix}.png")
...
def main():
    ...
    print("LINK PREDICTION EXPERIMENT: DIRECTORS MEETINGS 1976")
    print("="*60)
    ...
    network_info = {
        'path': NETWORK_PATH,
        'description': f"1976 network with {G.number_of_nodes()} nodes and {G.number_of_edges()} edges",
