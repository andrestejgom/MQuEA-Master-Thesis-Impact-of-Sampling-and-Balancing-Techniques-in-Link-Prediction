...
import sys
sys.stdout = open('sbm_s166_167_167_pi0.0125_pe0.00125.txt', 'w')
...
# Configuration
NETWORK_PATH = "synthetic_networks/stochastic_block_model/sbm_s166_167_167_pi0.0125_pe0.00125"
RESULTS_DIR = "sbm_s166_167_167_pi0.0125_pe0.00125_predictions"
RANDOM_STATE = 42
...
def save_experiment_results(all_results, network_info):
    ...
    # Save to Excel file
    excel_file = os.path.join(RESULTS_DIR, "sbm_s166_167_167_pi0.0125_pe0.00125_results.xlsx")
...
def create_visualizations(summary_df, network_info):
    ...
    for sampling_method in sampling_methods:
        ...
        fig1.tight_layout()
        plot_file1 = os.path.join(RESULTS_DIR, f"sbm_s166_167_167_pi0.0125_pe0.00125_aupr_if_predictions_{sampling_suffix}.png")
        ...
        fig2.tight_layout()
        plot_file2 = os.path.join(RESULTS_DIR, f"sbm_s166_167_167_pi0.0125_pe0.00125_auc_predictions_{sampling_suffix}.png")
        ...
        fig3.tight_layout()
        plot_file3 = os.path.join(RESULTS_DIR, f"sbm_s166_167_167_pi0.0125_pe0.00125_aupr_predictions_{sampling_suffix}.png")
        ...
        fig4.tight_layout()
        plot_file4 = os.path.join(RESULTS_DIR, f"sbm_s166_167_167_pi0.0125_pe0.00125_aupr_if_table_{sampling_suffix}.png")
        ...
        fig5.tight_layout()
        plot_file5 = os.path.join(RESULTS_DIR, f"sbm_s166_167_167_pi0.0125_pe0.00125_auc_table_{sampling_suffix}.png")
        ...
        fig6.tight_layout()
        plot_file6 = os.path.join(RESULTS_DIR, f"sbm_s166_167_167_pi0.0125_pe0.00125_aupr_table_{sampling_suffix}.png")
