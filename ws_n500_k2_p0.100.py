...
import sys
sys.stdout = open('ws_n500_k2_p0.100.txt', 'w')
...
# Configuration
NETWORK_PATH = "synthetic_networks/watts_strogatz/ws_n500_k2_p0.100"
RESULTS_DIR = "ws_n500_k2_p0.100_predictions"
RANDOM_STATE = 42
...
def save_experiment_results(all_results, network_info):
    ...
    # Save to Excel file
    excel_file = os.path.join(RESULTS_DIR, "ws_n500_k2_p0.100_results.xlsx")
...
def create_visualizations(summary_df, network_info):
    ...
    for sampling_method in sampling_methods:
        ...
        fig1.tight_layout()
        plot_file1 = os.path.join(RESULTS_DIR, f"ws_n500_k2_p0.100_aupr_if_predictions_{sampling_suffix}.png")
        ...
        fig2.tight_layout()
        plot_file2 = os.path.join(RESULTS_DIR, f"ws_n500_k2_p0.100_auc_predictions_{sampling_suffix}.png")
        ...
        fig3.tight_layout()
        plot_file3 = os.path.join(RESULTS_DIR, f"ws_n500_k2_p0.100_aupr_predictions_{sampling_suffix}.png")
        ...
        fig4.tight_layout()
        plot_file4 = os.path.join(RESULTS_DIR, f"ws_n500_k2_p0.100_aupr_if_table_{sampling_suffix}.png")
        ...
        fig5.tight_layout()
        plot_file5 = os.path.join(RESULTS_DIR, f"ws_n500_k2_p0.100_auc_table_{sampling_suffix}.png")
        ...
        fig6.tight_layout()
        plot_file6 = os.path.join(RESULTS_DIR, f"ws_n500_k2_p0.100_aupr_table_{sampling_suffix}.png")
