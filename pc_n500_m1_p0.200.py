...
import sys
sys.stdout = open('pc_n500_m1_p0.200.txt', 'w')
...
# Configuration
NETWORK_PATH = "synthetic_networks/powerlaw_cluster/pc_n500_m1_p0.200"
RESULTS_DIR = "pc_n500_m1_p0.200_predictions"
RANDOM_STATE = 42
...
def save_experiment_results(all_results, network_info):
    ...
    # Save to Excel file
    excel_file = os.path.join(RESULTS_DIR, "pc_n500_m1_p0.200_results.xlsx")
...
def create_visualizations(summary_df, network_info):
    ...
    for sampling_method in sampling_methods:
        ...
        fig1.tight_layout()
        plot_file1 = os.path.join(RESULTS_DIR, f"pc_n500_m1_p0.200_aupr_if_predictions_{sampling_suffix}.png")
        ...
        fig2.tight_layout()
        plot_file2 = os.path.join(RESULTS_DIR, f"pc_n500_m1_p0.200_auc_predictions_{sampling_suffix}.png")
        ...
        fig3.tight_layout()
        plot_file3 = os.path.join(RESULTS_DIR, f"pc_n500_m1_p0.200_aupr_predictions_{sampling_suffix}.png")
        ...
        fig4.tight_layout()
        plot_file4 = os.path.join(RESULTS_DIR, f"pc_n500_m1_p0.200_aupr_if_table_{sampling_suffix}.png")
        ...
        fig5.tight_layout()
        plot_file5 = os.path.join(RESULTS_DIR, f"pc_n500_m1_p0.200_auc_table_{sampling_suffix}.png")
        ...
        fig6.tight_layout()
        plot_file6 = os.path.join(RESULTS_DIR, f"pc_n500_m1_p0.200_aupr_table_{sampling_suffix}.png")
...
def main():
    ...
    print("LINK PREDICTION EXPERIMENT ON POWERLAW CLUSTER NETWORK")
    print("="*60)
    ...
    network_info = {
       'path': NETWORK_PATH,
       'description': f"Powerlaw Cluster network with {G.number_of_nodes()} nodes and {G.number_of_edges()} edges",
       'nodes': G.number_of_nodes(),
       'edges': G.number_of_edges(),
       'density': nx.density(G),
       'type': G.graph.get('network_type', 'powerlaw_cluster')
    }
